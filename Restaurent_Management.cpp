...
int main(){
	...
	int citem;
	head = NULL;
	insertfirst(5,"(char*)Burger",23,175.00);
//	insertend(6,"(char*)Pizza",13,250.00);
//	insertend(1,"(char*)Hot Cake",8,475.00);
//	insertend(2,"(char*)Coffee",46,325.00);
//	insertend(3,"(char*)Ice cream",46,230.00);
//	insertend(4,"(char*)Sandwich ",34,320.00);
//	insertend(7,"(char*)Grill    ",7,100);
//	insertend(8,"(char*)Pancakes ",121,350.00);
//	insertend(9,"(char*)Cold Drinks",73,120.00);
	mainmenu:
	br(1);
	main_menu();
...
void loadData() {
     ...
     while(fscanf(filePointer, "%d, %s , %d, %f, %[^\n]", &foodNo, foodName, &foodStock, &foodPrice) != EOF) {
		...
		insertend(foodNo, foodName, foodStock, foodPrice);
	 }
}
